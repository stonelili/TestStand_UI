...
{
	[Serializable]
	public class StartupUI : Form, ISerializable
	{
		...
		public StartupUI(SerializationInfo info, StreamingContext context)
		{
		...
		private void timer1_Tick(object sender, EventArgs e)
		{
			...
			if (!(base.Opacity >= 1.0))
			{
				base.Opacity = 0.05 * (double)TimerCount;
		...
		{
			label_Version.Text = "Ver: " + Assembly.GetExecutingAssembly().GetName().Version.ToString();
		}
		...
		private void InitializeComponent()
		{
			...
			this.label_Version.Location = new System.Drawing.Point(368, 240);
			this.label_Version.Name = "label_Version";
			this.label_Version.Size = new System.Drawing.Size(77, 12);
			this.label_Version.TabIndex = 2;
			this.label_Version.Text = "Ver: 2.1.1.0";
